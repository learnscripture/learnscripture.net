...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'comments_comment', 'group',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='comments', null=True, to=orm['groups.Group']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Comment.group'
        db.delete_column(u'comments_comment', 'group_id')
