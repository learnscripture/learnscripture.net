...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Comment.event'
        db.alter_column(u'comments_comment', 'event_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['events.Event']))

    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'Comment.event'
        raise RuntimeError("Cannot reverse this migration. 'Comment.event' and its values cannot be restored.")
    ...
    models = {
        ...
        u'comments.comment': {
            ...
            'event': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'comments'", 'null': 'True', 'to': u"orm['events.Event']"}),
