...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Identity.desktop_testing_method'
        db.add_column(u'accounts_identity', 'desktop_testing_method',
                      self.gf('django.db.models.fields.PositiveSmallIntegerField')(default=0),
                      keep_default=False)

        # Adding field 'Identity.touchscreen_testing_method'
        db.add_column(u'accounts_identity', 'touchscreen_testing_method',
                      self.gf('django.db.models.fields.PositiveSmallIntegerField')(default=2),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Identity.desktop_testing_method'
        db.delete_column(u'accounts_identity', 'desktop_testing_method')

        # Deleting field 'Identity.touchscreen_testing_method'
        db.delete_column(u'accounts_identity', 'touchscreen_testing_method')
