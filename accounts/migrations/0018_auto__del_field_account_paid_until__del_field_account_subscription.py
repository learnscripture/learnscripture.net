...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Account.paid_until'
        db.delete_column('accounts_account', 'paid_until')

        # Deleting field 'Account.subscription'
        db.delete_column('accounts_account', 'subscription')


    def backwards(self, orm):
        # Adding field 'Account.paid_until'
        db.add_column('accounts_account', 'paid_until',
                      self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Account.subscription'
        db.add_column('accounts_account', 'subscription',
