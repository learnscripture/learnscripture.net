...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Identity.track_learning'
        db.add_column(u'accounts_identity', 'track_learning',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Identity.track_learning'
        db.delete_column(u'accounts_identity', 'track_learning')
    ...
    models = {
        ...
        u'accounts.identity': {
            ...
            'track_learning': ('django.db.models.fields.BooleanField', [], {'default': 'False'})
        },
        u'accounts.notice': {
