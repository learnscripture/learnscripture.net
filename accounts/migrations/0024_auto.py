...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding M2M table for field following on 'Account'
        db.create_table(u'accounts_account_following', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('from_account', models.ForeignKey(orm[u'accounts.account'], null=False)),
            ('to_account', models.ForeignKey(orm[u'accounts.account'], null=False))
        ))
        db.create_unique(u'accounts_account_following', ['from_account_id', 'to_account_id'])


    def backwards(self, orm):
        # Removing M2M table for field following on 'Account'
        db.delete_table('accounts_account_following')
