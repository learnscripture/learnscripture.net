...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Notice.seen'
        db.add_column('accounts_notice', 'seen',
                      self.gf('django.db.models.fields.DateTimeField')(default=None, null=True, blank=True),
                      keep_default=False)

    def backwards(self, orm):
        # Deleting field 'Notice.seen'
        db.delete_column('accounts_notice', 'seen')

    models = {
        'accounts.account': {
            'Meta': {'ordering': "['username']", 'object_name': 'Account'},
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 7, 24, 23, 10, 21, 838458)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 7, 24, 23, 10, 21, 838270)'}),
        ...
        'accounts.identity': {
            ...
            'date_created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 7, 24, 23, 10, 21, 840462)'}),
        ...
        'accounts.notice': {
            ...
            'created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 7, 24, 23, 10, 21, 839863)'}),
