...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Identity.testing_method'
        db.add_column('accounts_identity', 'testing_method',
                      self.gf('django.db.models.fields.PositiveSmallIntegerField')(default=None, null=True),
                      keep_default=False)

    def backwards(self, orm):
        # Deleting field 'Identity.testing_method'
        db.delete_column('accounts_identity', 'testing_method')

    models = {
        'accounts.account': {
            'Meta': {'object_name': 'Account'},
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 2, 14, 12, 30, 21, 937973)'}),
            'email': ('django.db.models.fields.EmailField', [], {'unique': 'True', 'max_length': '75'}),
            'first_name': ('django.db.models.fields.CharField', [], {'max_length': '100', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 2, 14, 12, 30, 21, 937776)'}),
        ...
        'accounts.identity': {
            ...
            'date_created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 2, 14, 12, 30, 21, 938730)'}),
