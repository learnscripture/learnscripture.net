...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Account.enable_commenting'
        db.add_column(u'accounts_account', 'enable_commenting',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Account.enable_commenting'
        db.delete_column(u'accounts_account', 'enable_commenting')
