...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Identity.enable_sounds'
        db.add_column(u'accounts_identity', 'enable_sounds',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Identity.enable_sounds'
        db.delete_column(u'accounts_identity', 'enable_sounds')
