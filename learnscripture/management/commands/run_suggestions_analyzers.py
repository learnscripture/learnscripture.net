...
class Command(BaseCommand):
    def add_arguments(self, parser):
        ...
        parser.add_argument('--disallow-text-loading', action='store_true', default=False,
    ...
    def handle(self, *args, **options):
        ...
        analyze_all(version_slugs=options.get('version_slug', None),
                    disallow_text_loading=options['disallow_text_loading'])
