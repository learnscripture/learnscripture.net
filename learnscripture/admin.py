...
convert_to_individual_notices_identities = make_convert_to_individual_notices(
    notify_all_identities, "convert_to_individual_notices_identities", "Convert to individual notices - all identities"
)
convert_to_individual_notices_accounts = make_convert_to_individual_notices(
    notify_all_accounts, "convert_to_individual_notices_accounts", "Convert to individual notices - all accounts"
)
