...
def check_allowed(request, feature):
    ...
    need_to_subscribe = mark_safe(u"Your free trial or paid subscription has finished, so you cannot create perform this action. You can <a href='%s'>subscribe</a> to enable this feature."
                                 % reverse('subscribe'))
