...
class CreateSetTests(BibleVersesMixin, FullBrowserTest):
    ...
    def test_create_selection_set(self):
        ...
        self.fill({"#id_name": "My set", "#id_description": "My description"})
    ...
    def test_edit(self):
        vs = VerseSet.objects.create(
            created_by=self._account, set_type=VerseSetType.SELECTION, language_code="en", name="my set"
        )
        vc1 = vs.verse_choices.create(internal_reference="BOOK0 1:1", set_order=0)
        vc2 = vs.verse_choices.create(internal_reference="BOOK0 1:5", set_order=1)
        vc3 = vs.verse_choices.create(internal_reference="BOOK0 1:10", set_order=2)
        self.login(self._account)
        self.get_url("edit_set", slug=vs.slug)
        self.drag_and_drop("#id-verse-list tbody tr:nth-child(2)", "#id-verse-list thead tr")
        self.submit("#id-save-btn")
    ...
    def test_remove(self):
        self.login(self._account)
        vs = VerseSet.objects.create(
            created_by=self._account, language_code="en", set_type=VerseSetType.SELECTION, name="my set"
        )
        vs.verse_choices.create(internal_reference="BOOK0 1:1", set_order=0)
        vc2 = vs.verse_choices.create(internal_reference="BOOK0 1:5", set_order=1)
