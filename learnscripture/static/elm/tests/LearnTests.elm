    ...
    describe "Learn.elm"
        ...
        , describe "inputTypeForWord"
            ...
            , test "reference" <|
                \_ ->
                    Expect.equal
                        [ Alphanumerical, Alphanumerical, Numerical, Numerical ]
                        (inputTypesForReference "1 Samuel 2:3")
            ]
        ]


inputTypesForReference : String -> List InputType
inputTypesForReference ref =
    referenceToParts ref
        |> List.filterMap
            (\p ->
                case p of
                    WordPart w ->
                        Just (inputTypeForWord w)
