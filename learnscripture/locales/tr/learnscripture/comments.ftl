...
comments-comment-list-title = Yorumlar

# Link that displays box for writing comment
comments-add-comment-link = Yorum ekle
...
comments-event-title-html = “{ $item_title }” bildirisne ekle:

# Button to moderate/hide a comment, used only by moderators
comments-moderate-comment-button = Yoruları yönet
...
comments-post-button = Gönder

# Button to cancel posting a comment
comments-cancel-button = İptal
...
comments-login-to-add-comments-html = Yorum yapabilmek için <a href="{ $login_url }">giriş yapmalısınız</a>.
