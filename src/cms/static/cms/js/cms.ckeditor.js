...
Cms.enhance_textarea = function(textarea, auto_height) {
	...
	window.CKEDITOR_CONFIG_TOOLBAR = window.CKEDITOR_CONFIG_TOOLBAR || [
		...
		['fFileLink','fImageLink','fCustomLink','fUnlink'],
		['fImage','Table'],
	...
	CKEDITOR.replace(textarea, {
		...
		extraPlugins: window.CKEDITOR_CONFIG_EXTRA_PLUGINS || 'ffilelink,fimagelink,fcustomlink,funlink,fimage,table,tabletools',
...
function extend_CKEditor() {
	...
	var ffilelinkCmd = {
		...
		exec: function(editor) {
			...
			var file_select_dialog = new Cms.FileSelectDialog();
	...
	var fimagelinkCmd = {
		...
		exec: function(editor) {
			...
			var image_select_dialog = new Cms.ImageSelectDialog();
