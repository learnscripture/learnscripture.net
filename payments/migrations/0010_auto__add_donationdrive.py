...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'DonationDrive'
        db.create_table(u'payments_donationdrive', (
            ...
            ('hide_if_donated_days', self.gf('django.db.models.fields.PositiveIntegerField')()),
        ))
        db.send_create_signal(u'payments', ['DonationDrive'])


    def backwards(self, orm):
        # Deleting model 'DonationDrive'
        db.delete_table(u'payments_donationdrive')
    ...
    models = {
        ...
        u'payments.donationdrive': {
            'Meta': {'object_name': 'DonationDrive'},
            'active': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'finish': ('django.db.models.fields.DateTimeField', [], {}),
            'hide_if_donated_days': ('django.db.models.fields.PositiveIntegerField', [], {}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
