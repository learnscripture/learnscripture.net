...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('payments_fund', 'currency',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['payments.Currency']),
                      keep_default=False)

    def backwards(self, orm):
        # Deleting field 'Fund.currency'
        db.delete_column('payments_fund', 'currency_id')

    models = {
        'accounts.account': {
            'Meta': {'object_name': 'Account'},
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 6, 12, 20, 1, 26, 186971)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 6, 12, 20, 1, 26, 186780)'}),
