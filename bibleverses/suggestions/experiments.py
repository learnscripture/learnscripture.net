...
TEXTS = [
    ...
    'unclean. ',
    "She went up and laid him down on the prophet's bed. She shut the door behind "
    'her and left. ',
    ...
    'God. ',
    'He followed in the footsteps of the kings of Israel; he also made images of '
    'the Baals. ',
    ...
    'I will lay waste your cities; and you will become desolate. Then you will '
    ...
    'Awake, my soul! Awake, O stringed instrument and harp! I will wake up at '
    'dawn!',
    'and the stars in the sky fell to the earth like a fig tree dropping its '
    'unripe figs when shaken by a fierce wind. ',
    'testifying to both Jews and Greeks about repentance toward God and faith in '
    'our Lord Jesus. ',
    ...
    'One of you makes a thousand run away, for the LORD your God fights for you '
    'as he promised you he would. ',
    'Are not my days few? Cease, then, and leave me alone, that I may find a '
    'little comfort,',
    ...
    'Johanan was the father of Azariah, who served as a priest in the temple '
    'Solomon built in Jerusalem. ',
    'If he designated her for his son, then he will deal with her according to '
    'the customary rights of daughters. ',
    ...
    'So Jesus replied, "My teaching is not from me, but from the one who sent '
    'me. ',
    ...
    'of Israel. ',
    'Dark clouds surround him; equity and justice are the foundation of his '
    'throne. ',
    'If he designated her for his son, then he will deal with her according to '
    'the customary rights of daughters. ',
    ...
    'in the land."',
    'A fool will no longer be called honorable; a deceiver will no longer be '
    'called principled. ',
    'This is the account of Isaac, the son of Abraham. Abraham became the father '
    'of Isaac. ',
    ...
    'I heard, but I did not understand. So I said, "Sir, what will happen after '
    'these things?"',
    ...
    'Both the apostles and the elders met together to deliberate about this '
    'matter. ',
    ...
    'a nation of stern appearance that will have no regard for the elderly or '
    'pity for the young. ',
    ...
    'the tabernacle with its tent, its covering, its clasps, its frames, its '
    ...
    "The LORD answered Elijah's prayer; the boy's breath returned to him and he "
    'lived. ',
    ...
    'citizen."',
    'He said to me, "You are my servant, Israel, through whom I will reveal my '
    'splendor."',
    ...
    'a handful of people. ',
    'But as the church submits to Christ, so also wives should submit to their '
    ...
    'star!"',
    'By his power he stills the sea; by his wisdom he cut Rahab the great sea '
    'monster to pieces. ',
    'Alammelech, Amad, and Mishal. Their border touched Carmel to the west and '
    'Shihor Libnath. ',
    'Pay attention to me and answer me! I am so upset and distressed, I am beside '
    'myself,',
    ...
    'kingdom',
    'Confirm to your servant your promise, which you made to the one who honors '
    'you. ',
    ...
    'prince. ',
    'Make the work harder for the men so they will keep at it and pay no '
    'attention to lying words!"',
    'For this reason I carefully follow all your precepts. I hate all deceitful '
    'actions. ',
    ...
    'While they were perplexed about this, suddenly two men stood beside them in '
    'dazzling attire. ',
    ...
    'Those that entered were male and female, just as God commanded him. Then the '
    'LORD shut him in. ',
    "Do you have an arm as powerful as God's, and can you thunder with a voice "
    'like his?',
    'And sons were also born to Shem (the older brother of Japheth), the father '
