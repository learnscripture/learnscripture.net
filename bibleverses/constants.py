...
class BookInfo:
    chapter_count: int
    verse_counts: dict[int, int]  # Verse counts for each book chapter, 1-indexed


BIBLE_BOOK_INFO: dict[str, BookInfo] = {
    "BOOK0": BookInfo(
        chapter_count=50,
        verse_counts={
            1: 31,
    ...
    "BOOK7": BookInfo(chapter_count=4, verse_counts={1: 22, 2: 23, 3: 18, 4: 22}),
    "BOOK8": BookInfo(
        chapter_count=31,
        verse_counts={
            1: 28,
    ...
    "BOOK14": BookInfo(
        chapter_count=10, verse_counts={1: 11, 2: 70, 3: 13, 4: 24, 5: 17, 6: 22, 7: 28, 8: 36, 9: 15, 10: 44}
    ),
    "BOOK15": BookInfo(
        chapter_count=13,
        verse_counts={1: 11, 2: 20, 3: 32, 4: 23, 5: 19, 6: 19, 7: 73, 8: 18, 9: 38, 10: 39, 11: 36, 12: 47, 13: 31},
    ),
    "BOOK16": BookInfo(
        chapter_count=10, verse_counts={1: 22, 2: 23, 3: 15, 4: 17, 5: 14, 6: 14, 7: 10, 8: 17, 9: 32, 10: 3}
    ),
    "BOOK17": BookInfo(
        chapter_count=42,
        verse_counts={
    ...
    "BOOK21": BookInfo(chapter_count=8, verse_counts={1: 17, 2: 17, 3: 11, 4: 16, 5: 16, 6: 13, 7: 13, 8: 14}),
    "BOOK22": BookInfo(
        chapter_count=66,
        verse_counts={
            1: 31,
    ...
    "BOOK24": BookInfo(chapter_count=5, verse_counts={1: 22, 2: 22, 3: 66, 4: 22, 5: 22}),
    "BOOK25": BookInfo(
        chapter_count=48,
        verse_counts={
            1: 28,
    ...
    "BOOK28": BookInfo(chapter_count=3, verse_counts={1: 20, 2: 32, 3: 21}),
    "BOOK29": BookInfo(chapter_count=9, verse_counts={1: 15, 2: 16, 3: 15, 4: 13, 5: 27, 6: 14, 7: 17, 8: 14, 9: 15}),
    "BOOK30": BookInfo(chapter_count=1, verse_counts={1: 21}),
    "BOOK31": BookInfo(chapter_count=4, verse_counts={1: 17, 2: 10, 3: 10, 4: 11}),
    "BOOK32": BookInfo(chapter_count=7, verse_counts={1: 16, 2: 13, 3: 12, 4: 13, 5: 15, 6: 16, 7: 20}),
    "BOOK33": BookInfo(chapter_count=3, verse_counts={1: 15, 2: 13, 3: 19}),
    "BOOK34": BookInfo(chapter_count=3, verse_counts={1: 17, 2: 20, 3: 19}),
    "BOOK35": BookInfo(chapter_count=3, verse_counts={1: 18, 2: 15, 3: 20}),
    "BOOK36": BookInfo(chapter_count=2, verse_counts={1: 15, 2: 23}),
    "BOOK37": BookInfo(
        chapter_count=14,
        verse_counts={
            1: 21,
    ...
    "BOOK38": BookInfo(chapter_count=4, verse_counts={1: 14, 2: 17, 3: 18, 4: 6}),
    "BOOK39": BookInfo(
        chapter_count=28,
        verse_counts={
            1: 25,
    ...
    "BOOK46": BookInfo(
        chapter_count=13,
        verse_counts={1: 24, 2: 17, 3: 18, 4: 18, 5: 21, 6: 18, 7: 16, 8: 24, 9: 15, 10: 18, 11: 33, 12: 21, 13: 14},
    ),
    "BOOK47": BookInfo(chapter_count=6, verse_counts={1: 24, 2: 21, 3: 29, 4: 31, 5: 26, 6: 18}),
    "BOOK48": BookInfo(chapter_count=6, verse_counts={1: 23, 2: 22, 3: 21, 4: 32, 5: 33, 6: 24}),
    "BOOK49": BookInfo(chapter_count=4, verse_counts={1: 30, 2: 30, 3: 21, 4: 23}),
    "BOOK50": BookInfo(chapter_count=4, verse_counts={1: 29, 2: 23, 3: 25, 4: 18}),
    "BOOK51": BookInfo(chapter_count=5, verse_counts={1: 10, 2: 20, 3: 13, 4: 18, 5: 28}),
    "BOOK52": BookInfo(chapter_count=3, verse_counts={1: 12, 2: 17, 3: 18}),
    "BOOK53": BookInfo(chapter_count=6, verse_counts={1: 20, 2: 15, 3: 16, 4: 16, 5: 25, 6: 21}),
    "BOOK54": BookInfo(chapter_count=4, verse_counts={1: 18, 2: 26, 3: 17, 4: 22}),
    "BOOK55": BookInfo(chapter_count=3, verse_counts={1: 16, 2: 15, 3: 15}),
    "BOOK56": BookInfo(chapter_count=1, verse_counts={1: 25}),
    "BOOK57": BookInfo(
        chapter_count=13,
        verse_counts={1: 14, 2: 18, 3: 19, 4: 16, 5: 14, 6: 20, 7: 28, 8: 13, 9: 28, 10: 39, 11: 40, 12: 29, 13: 25},
    ),
    "BOOK58": BookInfo(chapter_count=5, verse_counts={1: 27, 2: 26, 3: 18, 4: 17, 5: 20}),
    "BOOK59": BookInfo(chapter_count=5, verse_counts={1: 25, 2: 25, 3: 22, 4: 19, 5: 14}),
    "BOOK60": BookInfo(chapter_count=3, verse_counts={1: 21, 2: 22, 3: 18}),
    "BOOK61": BookInfo(chapter_count=5, verse_counts={1: 10, 2: 29, 3: 24, 4: 21, 5: 21}),
    "BOOK62": BookInfo(chapter_count=1, verse_counts={1: 13}),
    "BOOK63": BookInfo(chapter_count=1, verse_counts={1: 15}),
    "BOOK64": BookInfo(chapter_count=1, verse_counts={1: 25}),
    "BOOK65": BookInfo(
        chapter_count=22,
        verse_counts={
            1: 20,
