...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'VerseSet.passage_id'
        db.add_column('bibleverses_verseset', 'passage_id',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=203),
                      keep_default=False)

    def backwards(self, orm):
        # Deleting field 'VerseSet.passage_id'
        db.delete_column('bibleverses_verseset', 'passage_id')

    models = {
        'accounts.account': {
            'Meta': {'ordering': "['username']", 'object_name': 'Account'},
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 7, 21, 2, 25, 30, 597209)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 7, 21, 2, 25, 30, 597042)'}),
        ...
        'accounts.identity': {
            ...
            'date_created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 7, 21, 2, 25, 30, 593824)'}),
        ...
        'bibleverses.verseset': {
            ...
            'bible_verse_number_end': ('django.db.models.fields.PositiveSmallIntegerField', [], {'null': 'True', 'blank': 'True'}),
            'bible_verse_number_start': ('django.db.models.fields.PositiveSmallIntegerField', [], {'null': 'True', 'blank': 'True'}),
            ...
            'date_added': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 7, 21, 2, 25, 30, 595552)'}),
