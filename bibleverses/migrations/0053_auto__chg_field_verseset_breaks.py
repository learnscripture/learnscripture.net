...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'VerseSet.breaks'
        db.alter_column('bibleverses_verseset', 'breaks', self.gf('django.db.models.fields.TextField')())

    def backwards(self, orm):

        # Changing field 'VerseSet.breaks'
        db.alter_column('bibleverses_verseset', 'breaks', self.gf('django.db.models.fields.CharField')(max_length=255))
