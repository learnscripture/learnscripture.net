...
class Migration(DataMigration):
    ...
    def forwards(self, orm):
        try:
            version = orm['bibleverses.BibleVersion'].objects.filter(short_name='KJV')[0]
        except IndexError:
            # This can only happen when running tests, and there is nothing to correct
            return
        def get_bible_verse_number(vc):
            return version.verse_set.get(reference=vc.reference).bible_verse_number

        for vs in orm['bibleverses.VerseSet'].objects.filter(set_type=2): # PASSAGE
            verse_choices = list(vs.verse_choices.order_by('set_order'))
            if len(verse_choices) > 0:
                vs.bible_verse_number_start = get_bible_verse_number(verse_choices[0])
                vs.bible_verse_number_end = get_bible_verse_number(verse_choices[-1])
                vs.save()
    ...
    models = {
        'accounts.account': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 4, 25, 13, 4, 38, 183045)'}),
            'email': ('django.db.models.fields.EmailField', [], {'unique': 'True', 'max_length': '75'}),
            'first_name': ('django.db.models.fields.CharField', [], {'max_length': '100', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'is_tester': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 4, 25, 13, 4, 38, 180541)'}),
        ...
        'accounts.identity': {
            ...
            'date_created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 4, 25, 13, 4, 38, 184132)'}),
        ...
        'bibleverses.verseset': {
            ...
            'date_added': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 4, 25, 13, 4, 38, 189850)'}),
