...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        db.rename_column('bibleverses_userversestatus', 'verse_id', 'verse_choice_id')

    def backwards(self, orm):
        db.rename_column('bibleverses_userversestatus', 'verse_choice_id', 'verse_id')

    models = {
        'accounts.account': {
            'Meta': {'object_name': 'Account'},
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 1, 26, 2, 14, 8, 33775)'}),
            'email': ('django.db.models.fields.EmailField', [], {'unique': 'True', 'max_length': '75'}),
            'first_name': ('django.db.models.fields.CharField', [], {'max_length': '100', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 1, 26, 2, 14, 8, 33538)'}),
        ...
        'accounts.identity': {
            ...
            'date_created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 1, 26, 2, 14, 8, 38448)'}),
