...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # This was missing for some unknown reason
        db.execute('ALTER TABLE bibleverses_userversestatus ADD CONSTRAINT bibleverses_userversestatus_pkey PRIMARY KEY ("id");')
