...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'WordSuggestionData.hash'
        db.add_column(u'bibleverses_wordsuggestiondata', 'hash',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=40),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'WordSuggestionData.hash'
        db.delete_column(u'bibleverses_wordsuggestiondata', 'hash')
