...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding unique constraint on 'WordSuggestionData', fields ['version_slug', 'reference']
        db.create_unique(u'bibleverses_wordsuggestiondata', ['version_slug', 'reference'])


    def backwards(self, orm):
        # Removing unique constraint on 'WordSuggestionData', fields ['version_slug', 'reference']
        db.delete_unique(u'bibleverses_wordsuggestiondata', ['version_slug', 'reference'])
