...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        db.execute("ALTER TABLE bibleverses_verse ADD COLUMN text_tsv tsvector;")
        db.execute("CREATE INDEX bibleverses_verse_tsv_index ON bibleverses_verse USING gin(text_tsv);")
        db.execute("UPDATE bibleverses_verse SET text_tsv = to_tsvector(text);")

    def backwards(self, orm):
        db.delete_column('bibleverses_verse', 'text_tsv')

    models = {
        'accounts.account': {
            'Meta': {'object_name': 'Account'},
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 3, 3, 0, 9, 50, 478602)'}),
            'email': ('django.db.models.fields.EmailField', [], {'unique': 'True', 'max_length': '75'}),
            'first_name': ('django.db.models.fields.CharField', [], {'max_length': '100', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 3, 3, 0, 9, 50, 478392)'}),
        ...
        'accounts.identity': {
            ...
            'date_created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 3, 3, 0, 9, 50, 483924)'}),
        ...
        'bibleverses.verseset': {
            ...
            'date_added': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 3, 3, 0, 9, 50, 483228)'}),
