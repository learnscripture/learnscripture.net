...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'VerseChoice.verse_set'
        db.alter_column('bibleverses_versechoice', 'verse_set_id', self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['bibleverses.VerseSet']))
    def backwards(self, orm):

        # Changing field 'VerseChoice.verse_set'
        db.alter_column('bibleverses_versechoice', 'verse_set_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['bibleverses.VerseSet']))
    models = {
        'accounts.account': {
            'Meta': {'object_name': 'Account'},
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 2, 29, 21, 30, 44, 76216)'}),
            'email': ('django.db.models.fields.EmailField', [], {'unique': 'True', 'max_length': '75'}),
            'first_name': ('django.db.models.fields.CharField', [], {'max_length': '100', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 2, 29, 21, 30, 44, 76011)'}),
        ...
        'accounts.identity': {
            ...
            'date_created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 2, 29, 21, 30, 44, 78434)'}),
        ...
        'bibleverses.verseset': {
            ...
            'date_added': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 2, 29, 21, 30, 44, 79908)'}),
