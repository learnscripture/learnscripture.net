...
class Migration(DataMigration):
    ...
    def forwards(self, orm):
        ...
        for uvs in orm['bibleverses.UserVerseStatus'].objects.filter(next_test_due__isnull=True,
                                                                     last_tested__isnull=False):
            # Use update with filtering on last_test to avoid clobbering due to race conditions
            orm['bibleverses.UserVerseStatus'].objects.filter(id=uvs.id,
                                                              last_tested=uvs.last_tested)\
               .update(next_test_due=memorymodel.next_test_due(uvs.last_tested, uvs.strength))
    ...
    models = {
        'accounts.account': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 3, 19, 15, 37, 13, 918928)'}),
            'email': ('django.db.models.fields.EmailField', [], {'unique': 'True', 'max_length': '75'}),
            'first_name': ('django.db.models.fields.CharField', [], {'max_length': '100', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'is_tester': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 3, 19, 15, 37, 13, 918743)'}),
        ...
        'accounts.identity': {
            ...
            'date_created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 3, 19, 15, 37, 13, 921983)'}),
        ...
        'bibleverses.verseset': {
            ...
            'date_added': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 3, 19, 15, 37, 13, 915782)'}),
