...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_unique(u'bibleverses_userversestatus', ['for_identity_id', 'verse_set_id', 'version_id', 'reference'])


    def backwards(self, orm):
        # Removing unique constraint on 'UserVerseStatus', fields ['for_identity', 'verse_set', 'version', 'reference']
        db.delete_unique(u'bibleverses_userversestatus', ['for_identity_id', 'verse_set_id', 'version_id', 'reference'])
