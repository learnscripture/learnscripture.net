...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'WordSuggestionData'
        db.create_table(u'bibleverses_wordsuggestiondata', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('version', self.gf('django.db.models.fields.related.ForeignKey')(related_name='word_suggestion_data', to=orm['bibleverses.TextVersion'])),
            ('reference', self.gf('django.db.models.fields.CharField')(max_length=100)),
            ('suggestions', self.gf('jsonfield.fields.JSONField')()),
        ))
        db.send_create_signal(u'bibleverses', ['WordSuggestionData'])
    ...
    def backwards(self, orm):
        # Removing unique constraint on 'WordSuggestionData', fields ['version', 'reference']
        db.delete_unique(u'bibleverses_wordsuggestiondata', ['version_id', 'reference'])

        # Deleting model 'WordSuggestionData'
        db.delete_table(u'bibleverses_wordsuggestiondata')
