...
class Migration(DataMigration):
    ...
    def forwards(self, orm):
        # Bug meant that 'added' was sometimes sometimes being left as None.
        # In many cases we can fix it up:
        missing_added = orm['bibleverses.UserVerseStatus'].objects.filter(added__isnull=True)
        missing_added.filter(first_seen__isnull=False).update(added=models.F('first_seen'))
        missing_added.filter(last_tested__isnull=False).update(added=models.F('last_tested'))

        # Some we can delete
        MEMORY_STAGE_ZERO = 1
        missing_added.filter(ignored=True, memory_stage=MEMORY_STAGE_ZERO).delete()

        # For the rest, we just set to some time in the past.
        from django.utils import timezone
        missing_added.update(added=timezone.now() - timedelta(1))
    ...
    models = {
        'accounts.account': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 4, 21, 20, 25, 8, 208254)'}),
            'email': ('django.db.models.fields.EmailField', [], {'unique': 'True', 'max_length': '75'}),
            'first_name': ('django.db.models.fields.CharField', [], {'max_length': '100', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'is_tester': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 4, 21, 20, 25, 8, 205668)'}),
        ...
        'accounts.identity': {
            ...
            'date_created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 4, 21, 20, 25, 8, 211242)'}),
        ...
        'bibleverses.verseset': {
            ...
            'date_added': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 4, 21, 20, 25, 8, 215051)'}),
