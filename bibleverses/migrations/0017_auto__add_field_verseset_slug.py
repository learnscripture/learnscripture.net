...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'VerseSet.slug'
        db.add_column('bibleverses_verseset', 'slug',
                      self.gf('autoslug.fields.AutoSlugField')(max_length=50, unique_with=(), null=True, populate_from=None),
                      keep_default=False)

    def backwards(self, orm):
        # Deleting field 'VerseSet.slug'
        db.delete_column('bibleverses_verseset', 'slug')

    models = {
        'accounts.account': {
            'Meta': {'object_name': 'Account'},
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 2, 6, 12, 2, 6, 502997)'}),
            'email': ('django.db.models.fields.EmailField', [], {'unique': 'True', 'max_length': '75'}),
            'first_name': ('django.db.models.fields.CharField', [], {'max_length': '100', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 2, 6, 12, 2, 6, 502781)'}),
        ...
        'accounts.identity': {
            ...
            'date_created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 2, 6, 12, 2, 6, 505240)'}),
        ...
        'bibleverses.verseset': {
            ...
            'date_added': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 2, 6, 12, 2, 6, 504692)'}),
