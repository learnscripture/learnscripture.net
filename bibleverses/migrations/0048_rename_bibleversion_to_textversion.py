...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        db.rename_table('bibleverses_bibleversion', 'bibleverses_textversion')


    def backwards(self, orm):
        db.rename_table('bibleverses_textversion', 'bibleverses_bibleversion')

    models = {
        'accounts.account': {
            'Meta': {'ordering': "['username']", 'object_name': 'Account'},
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 9, 19, 16, 52, 9, 665517)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 9, 19, 16, 52, 9, 665321)'}),
        ...
        'accounts.identity': {
            ...
            'date_created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 9, 19, 16, 52, 9, 668909)'}),
        ...
        'bibleverses.verseset': {
            ...
            'date_added': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 9, 19, 16, 52, 9, 644056)'}),
