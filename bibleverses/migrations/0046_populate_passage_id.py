...
class Migration(DataMigration):
    ...
    def forwards(self, orm):
        ...
        for vs in orm['bibleverses.verseset'].objects.filter(set_type=VerseSetType.PASSAGE):
            choices = list(vs.verse_choices.order_by('set_order'))
            vs.passage_id = choices[0].reference + ' - ' + choices[-1].reference
            vs.save()
    ...
    models = {
        'accounts.account': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 7, 21, 2, 25, 59, 986676)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 7, 21, 2, 25, 59, 984050)'}),
        ...
        'accounts.identity': {
            ...
            'date_created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 7, 21, 2, 25, 59, 991748)'}),
        ...
        'bibleverses.verseset': {
            ...
            'date_added': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 7, 21, 2, 25, 59, 990140)'}),
