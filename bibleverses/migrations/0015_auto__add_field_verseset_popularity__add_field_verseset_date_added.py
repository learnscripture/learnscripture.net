...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'VerseSet.popularity'
        db.add_column('bibleverses_verseset', 'popularity',
                      self.gf('django.db.models.fields.PositiveIntegerField')(default=0),
                      keep_default=False)

        # Adding field 'VerseSet.date_added'
        db.add_column('bibleverses_verseset', 'date_added',
                      self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2012, 2, 2, 23, 33, 24, 856971)),
                      keep_default=False)

    def backwards(self, orm):
        # Deleting field 'VerseSet.popularity'
        db.delete_column('bibleverses_verseset', 'popularity')

        # Deleting field 'VerseSet.date_added'
        db.delete_column('bibleverses_verseset', 'date_added')

    models = {
        'accounts.account': {
            'Meta': {'object_name': 'Account'},
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 2, 2, 23, 33, 24, 882187)'}),
            'email': ('django.db.models.fields.EmailField', [], {'unique': 'True', 'max_length': '75'}),
            'first_name': ('django.db.models.fields.CharField', [], {'max_length': '100', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 2, 2, 23, 33, 24, 882008)'}),
        ...
        'accounts.identity': {
            ...
            'date_created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 2, 2, 23, 33, 24, 879067)'}),
