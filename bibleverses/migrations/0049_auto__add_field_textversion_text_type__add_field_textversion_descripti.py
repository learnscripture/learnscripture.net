...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'TextVersion.text_type'
        db.add_column('bibleverses_textversion', 'text_type',
                      self.gf('django.db.models.fields.PositiveSmallIntegerField')(default=1),
                      keep_default=False)

        # Adding field 'TextVersion.description'
        db.add_column('bibleverses_textversion', 'description',
                      self.gf('django.db.models.fields.TextField')(default='', blank=True),
                      keep_default=False)


        # Changing field 'UserVerseStatus.verse_set'
        db.alter_column('bibleverses_userversestatus', 'verse_set_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['bibleverses.VerseSet'], null=True, on_delete=models.SET_NULL))

    def backwards(self, orm):
        # Deleting field 'TextVersion.text_type'
        db.delete_column('bibleverses_textversion', 'text_type')

        # Deleting field 'TextVersion.description'
        db.delete_column('bibleverses_textversion', 'description')


        # Changing field 'UserVerseStatus.verse_set'
        db.alter_column('bibleverses_userversestatus', 'verse_set_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['bibleverses.VerseSet'], null=True))
