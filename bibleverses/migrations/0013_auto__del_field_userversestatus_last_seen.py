...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'UserVerseStatus.last_seen'
        db.delete_column('bibleverses_userversestatus', 'last_seen')

    def backwards(self, orm):
        # Adding field 'UserVerseStatus.last_seen'
        db.add_column('bibleverses_userversestatus', 'last_seen',
    ...
    models = {
        'accounts.account': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 1, 31, 20, 2, 39, 129348)'}),
            'email': ('django.db.models.fields.EmailField', [], {'unique': 'True', 'max_length': '75'}),
            'first_name': ('django.db.models.fields.CharField', [], {'max_length': '100', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 1, 31, 20, 2, 39, 129170)'}),
        ...
        'accounts.identity': {
            ...
            'date_created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 1, 31, 20, 2, 39, 126619)'}),
