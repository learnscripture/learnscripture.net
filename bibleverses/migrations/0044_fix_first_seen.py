...
class Migration(DataMigration):
    ...
    def forwards(self, orm):
        # Some verse are missing 'first_seen' when they really shouldn't be We
        # can't work it out, but we can guess based on the memory models
        for uvs in orm['bibleverses.UserVerseStatus'].objects.filter(ignored=False, strength__gt=0, first_seen__isnull=True, last_tested__isnull=False):
            # Get the t for this strength
            t = MM.t(uvs.strength)
            # Guess the original start time
            first_seen = uvs.last_tested - timedelta(seconds=t)
            if uvs.added > first_seen:
                first_seen = uvs.added
            uvs.first_seen = first_seen
            uvs.save()
    ...
    models = {
        'accounts.account': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 5, 1, 0, 57, 0, 894859)'}),
            'email': ('django.db.models.fields.EmailField', [], {'unique': 'True', 'max_length': '75'}),
            'first_name': ('django.db.models.fields.CharField', [], {'max_length': '100', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'is_tester': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 5, 1, 0, 57, 0, 892292)'}),
        ...
        'accounts.identity': {
            ...
            'date_created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 5, 1, 0, 57, 0, 900709)'}),
        ...
        'bibleverses.verseset': {
            ...
            'date_added': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 5, 1, 0, 57, 0, 898049)'}),
