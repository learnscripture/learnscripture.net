...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'VerseSet.created_by'
        db.add_column('bibleverses_verseset', 'created_by',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name='verse_sets_created', null=True, to=orm['accounts.Account']),
                      keep_default=False)

    def backwards(self, orm):
        # Deleting field 'VerseSet.created_by'
        db.delete_column('bibleverses_verseset', 'created_by_id')

    models = {
        'accounts.account': {
            'Meta': {'object_name': 'Account'},
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 2, 6, 15, 8, 37, 256123)'}),
            'email': ('django.db.models.fields.EmailField', [], {'unique': 'True', 'max_length': '75'}),
            'first_name': ('django.db.models.fields.CharField', [], {'max_length': '100', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 2, 6, 15, 8, 37, 255692)'}),
        ...
        'accounts.identity': {
            ...
            'date_created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 2, 6, 15, 8, 37, 261563)'}),
        ...
        'bibleverses.verseset': {
            ...
            'created_by': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'verse_sets_created'", 'null': 'True', 'to': "orm['accounts.Account']"}),
            'date_added': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 2, 6, 15, 8, 37, 259491)'}),
