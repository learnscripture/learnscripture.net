...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'VerseSet.bible_verse_number_start'
        db.add_column('bibleverses_verseset', 'bible_verse_number_start',
                      self.gf('django.db.models.fields.PositiveSmallIntegerField')(null=True),
                      keep_default=False)

        # Adding field 'VerseSet.bible_verse_number_end'
        db.add_column('bibleverses_verseset', 'bible_verse_number_end',
                      self.gf('django.db.models.fields.PositiveSmallIntegerField')(null=True),
                      keep_default=False)

    def backwards(self, orm):
        # Deleting field 'VerseSet.bible_verse_number_start'
        db.delete_column('bibleverses_verseset', 'bible_verse_number_start')

        # Deleting field 'VerseSet.bible_verse_number_end'
        db.delete_column('bibleverses_verseset', 'bible_verse_number_end')

    models = {
        'accounts.account': {
            'Meta': {'object_name': 'Account'},
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 4, 25, 13, 3, 55, 492682)'}),
            'email': ('django.db.models.fields.EmailField', [], {'unique': 'True', 'max_length': '75'}),
            'first_name': ('django.db.models.fields.CharField', [], {'max_length': '100', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'is_tester': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 4, 25, 13, 3, 55, 492501)'}),
        ...
        'accounts.identity': {
            ...
            'date_created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 4, 25, 13, 3, 55, 496070)'}),
        ...
        'bibleverses.verseset': {
            ...
            'date_added': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 4, 25, 13, 3, 55, 495292)'}),
