...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding unique constraint on 'UserVerseStatus', fields ['for_identity', 'verse_set', 'version', 'reference']
        db.create_unique('bibleverses_userversestatus', ['for_identity_id', 'verse_set_id', 'version_id', 'reference'])

    def backwards(self, orm):
        # Removing unique constraint on 'UserVerseStatus', fields ['for_identity', 'verse_set', 'version', 'reference']
        db.delete_unique('bibleverses_userversestatus', ['for_identity_id', 'verse_set_id', 'version_id', 'reference'])

    models = {
        'accounts.account': {
            'Meta': {'object_name': 'Account'},
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 2, 29, 18, 40, 59, 726122)'}),
            'email': ('django.db.models.fields.EmailField', [], {'unique': 'True', 'max_length': '75'}),
            'first_name': ('django.db.models.fields.CharField', [], {'max_length': '100', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 2, 29, 18, 40, 59, 725916)'}),
        ...
        'accounts.identity': {
            ...
            'date_created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 2, 29, 18, 40, 59, 729894)'}),
        ...
        'bibleverses.verseset': {
            ...
            'date_added': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 2, 29, 18, 40, 59, 731367)'}),
