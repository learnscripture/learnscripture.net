...
class Migration(DataMigration):
    ...
    def forwards(self, orm):
        from bibleverses.models import parse_ref
        for uvs in orm['bibleverses.UserVerseStatus'].objects.all().select_related('verse_choice'):
            uvs.verse_set_id = uvs.verse_choice.verse_set_id
            uvs.reference = uvs.verse_choice.reference
            vl = parse_ref(uvs.reference, uvs.version)
            uvs.bible_verse_number = vl[0].bible_verse_number
            uvs.save()

    def backwards(self, orm):
        orm['bibleverses.UserVerseStatus'].objects.update(verse_set=None)


    models = {
        'accounts.account': {
            'Meta': {'object_name': 'Account'},
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 2, 29, 16, 19, 37, 546073)'}),
            'email': ('django.db.models.fields.EmailField', [], {'unique': 'True', 'max_length': '75'}),
            'first_name': ('django.db.models.fields.CharField', [], {'max_length': '100', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 2, 29, 16, 19, 37, 545894)'}),
        ...
        'accounts.identity': {
            ...
            'date_created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 2, 29, 16, 19, 37, 546815)'}),
        ...
        'bibleverses.verseset': {
            ...
            'date_added': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 2, 29, 16, 19, 37, 544036)'}),
