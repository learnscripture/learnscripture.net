...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'QAPair'
        db.create_table('bibleverses_qapair', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('catechism', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['bibleverses.TextVersion'])),
        ...
        db.send_create_signal('bibleverses', ['QAPair'])

        # Adding unique constraint on 'QAPair', fields ['catechism', 'order']
        db.create_unique('bibleverses_qapair', ['catechism_id', 'order'])

        # Adding unique constraint on 'QAPair', fields ['catechism', 'reference']
        db.create_unique('bibleverses_qapair', ['catechism_id', 'reference'])


    def backwards(self, orm):
        # Removing unique constraint on 'QAPair', fields ['catechism', 'reference']
        db.delete_unique('bibleverses_qapair', ['catechism_id', 'reference'])

        # Removing unique constraint on 'QAPair', fields ['catechism', 'order']
        db.delete_unique('bibleverses_qapair', ['catechism_id', 'order'])

        # Deleting model 'QAPair'
        db.delete_table('bibleverses_qapair')
    ...
    models = {
        ...
        'bibleverses.qapair': {
            ...
            'catechism': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['bibleverses.TextVersion']"}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
