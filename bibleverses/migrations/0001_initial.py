    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "memory_stage",
                    models.PositiveSmallIntegerField(default=1, choices=[(1, "nothing"), (2, "seen"), (3, "tested")]),
                ),
                ...
                (
                    "for_identity",
                    models.ForeignKey(related_name="verse_statuses", to="accounts.Identity", on_delete=models.CASCADE),
                ),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "created_by",
                    models.ForeignKey(
                        related_name="verse_sets_created", to=settings.AUTH_USER_MODEL, on_delete=models.CASCADE
                    ),
                ),
            ],
            options={},
        ...
        migrations.AlterUniqueTogether(
            name="wordsuggestiondata",
            unique_together={("version_slug", "reference")},
        ),
        migrations.AddField(
        ...
        migrations.AlterUniqueTogether(
            name="verse",
            unique_together={("version", "bible_verse_number"), ("version", "reference")},
        ),
        migrations.AddField(
            model_name="userversestatus",
            name="verse_set",
            field=models.ForeignKey(
                on_delete=django.db.models.deletion.SET_NULL, blank=True, to="bibleverses.VerseSet", null=True
            ),
            preserve_default=True,
        ),
        migrations.AddField(
        ...
        migrations.AlterUniqueTogether(
            name="qapair",
            unique_together={("catechism", "order"), ("catechism", "reference")},
        ),
    ]
