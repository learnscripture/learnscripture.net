...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'VerseSet.slug'
        db.alter_column('bibleverses_verseset', 'slug', self.gf('autoslug.fields.AutoSlugField')(default='', unique=True, max_length=50, populate_from=None, unique_with=()))
    def backwards(self, orm):

        # Changing field 'VerseSet.slug'
        db.alter_column('bibleverses_verseset', 'slug', self.gf('autoslug.fields.AutoSlugField')(populate_from=None, unique=True, max_length=50, null=True, unique_with=()))
    models = {
        'accounts.account': {
            'Meta': {'object_name': 'Account'},
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 2, 7, 0, 18, 15, 478839)'}),
            'email': ('django.db.models.fields.EmailField', [], {'unique': 'True', 'max_length': '75'}),
            'first_name': ('django.db.models.fields.CharField', [], {'max_length': '100', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 2, 7, 0, 18, 15, 478637)'}),
        ...
        'accounts.identity': {
            ...
            'date_created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 2, 7, 0, 18, 15, 480752)'}),
        ...
        'bibleverses.verseset': {
            ...
            'date_added': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 2, 7, 0, 18, 15, 481871)'}),
