...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'UserVerseStatus.reference'
        db.add_column('bibleverses_userversestatus', 'reference',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=100),
                      keep_default=False)

        # Adding field 'UserVerseStatus.verse_set'
        db.add_column('bibleverses_userversestatus', 'verse_set',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['bibleverses.VerseSet'], null=True),
                      keep_default=False)

        # Adding field 'UserVerseStatus.bible_verse_number'
        db.add_column('bibleverses_userversestatus', 'bible_verse_number',
                      self.gf('django.db.models.fields.PositiveSmallIntegerField')(default=0),
                      keep_default=False)

    def backwards(self, orm):
        # Deleting field 'UserVerseStatus.reference'
        db.delete_column('bibleverses_userversestatus', 'reference')

        # Deleting field 'UserVerseStatus.verse_set'
        db.delete_column('bibleverses_userversestatus', 'verse_set_id')

        # Deleting field 'UserVerseStatus.bible_verse_number'
        db.delete_column('bibleverses_userversestatus', 'bible_verse_number')

    models = {
        'accounts.account': {
            'Meta': {'object_name': 'Account'},
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 2, 29, 16, 19, 22, 850616)'}),
            'email': ('django.db.models.fields.EmailField', [], {'unique': 'True', 'max_length': '75'}),
            'first_name': ('django.db.models.fields.CharField', [], {'max_length': '100', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 2, 29, 16, 19, 22, 850410)'}),
        ...
        'accounts.identity': {
            ...
            'date_created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 2, 29, 16, 19, 22, 852185)'}),
        ...
        'bibleverses.verseset': {
            ...
            'date_added': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 2, 29, 16, 19, 22, 849251)'}),
