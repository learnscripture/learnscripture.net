...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'UserVerseStatus.verse_choice'
        db.delete_column('bibleverses_userversestatus', 'verse_choice_id')

    def backwards(self, orm):
        # Adding field 'UserVerseStatus.verse_choice'
        db.add_column('bibleverses_userversestatus', 'verse_choice',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['bibleverses.VerseChoice'], null=True),
                      keep_default=False)

    models = {
        'accounts.account': {
            'Meta': {'object_name': 'Account'},
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 2, 29, 18, 35, 41, 685049)'}),
            'email': ('django.db.models.fields.EmailField', [], {'unique': 'True', 'max_length': '75'}),
            'first_name': ('django.db.models.fields.CharField', [], {'max_length': '100', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 2, 29, 18, 35, 41, 684867)'}),
        ...
        'accounts.identity': {
            ...
            'date_created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 2, 29, 18, 35, 41, 685814)'}),
        ...
        'bibleverses.verseset': {
            ...
            'date_added': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 2, 29, 18, 35, 41, 683784)'}),
